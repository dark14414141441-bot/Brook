local Libary = loadstring(game:HttpGet("https://pastefy.app/kIaTgQ8U/raw"))()
workspace.FallenPartsDestroyHeight = -math.huge

local Window = Libary:MakeWindow({
    Title = "⚡Poderoso Hub⚡ V7  | Brookhaven RP 🏡",
    SubTitle = "by Ressel and Luis22",
    LoadText = "Carregando Poderoso Hub",
    Flags = "PoderosoHub_Broookhaven"
})
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://85707712973346", BackgroundTransparency = 0 },
    Corner = { CornerRadius = UDim.new(35, 1) },
})

local InfoTab = Window:MakeTab({ Title = "Créditos", Icon = "rbxassetid://15309138473" })



InfoTab:AddSection({ "Informações do Script" })
InfoTab:AddParagraph({ "Criador / Desenvolvedor:", "Luis22 e Ressel." })
InfoTab:AddParagraph({ "Colaborações:", "Luís22 & Ressel" })
InfoTab:AddParagraph({ "Você está usando:", "Poderoso Hub Brookhaven " })
...
InfoTab:AddParagraph({ "Your Language", "English/Português" })

InfoTab:AddParagraph({ "You Using", "Poderoso Hub" })

InfoTab:AddParagraph({ "Hub Version", "Version 7" })
...
InfoTab:AddDiscordInvite({
    Name = "Poderoso Hub Community",
    Description = "https://discord.gg/4pgj4nMs",
    Logo = "rbxassetid://85707712973346",
    Invite = "https://discord.gg/4pgj4nMs",
})

local TrollTab = Window:MakeTab({ Title = "Fun", Icon = "rbxassetid://13364900349" })
...
local Tab = Window:MakeTab({"Áudio", "music"})

-- Create a section
Tab:AddSection({"Áudio visual, Porque foi já corrigido"})
...
local audios = {
    ...
    {Name = "SKIBIDI SKIBIDI SKIBIDI", ID = 128771670035179},
    {Name = "BRR BRR PATAPIM", ID = 117170901476451},
    {Name = "MONTAGEM TERRA", ID = 134770548505933},
...
Tab:AddParagraph({"Info", "Loop de tocar Áudio"})
...
Tab:AddParagraph({
    "Informação de Lag",
    "O lag começa após alguns segundos"
})
...
local names = {
    ...
    {"TUBERS93", " TUBERS 93 "},
    {"CO0LKID", " CO0 LKID "},
    {"GAME ATTACKED BY LUIS22", " GAME ATTACKED BY LUIS22 "},
    {"INC0MUN", " INC0MUN"},
    {"BAD BOY", " BAD BOY "}
}
...
CarTab:AddParagraph({"Informação:", "Os turbos não precisam de Gamepass"})
...
CarTab:AddDropdown({
    Name = "Select Music (Precisa de gamepass)",
    Options = musicIds,
    Callback = function(value)
        playCarMusic(value)
        playScooterMusic(value)
...
local playerChild = ChildTab:AddDropdown({
    Name = "Selecione um player para a criança perseguir",
    Options = players,
    Default = "",
...
-- Aba Local Player
local LocalPlayerTab = Window:MakeTab({"Player", "user"})
...
getgenv().PoderosoHubEnviarDelay = 1
...
LocalPlayerTab:AddSlider({
    ...
    Increment = 0.1,
    Callback = function(Value)
        getgenv().PoderosoHubEnviarDelay = Value
    end
})
...
LocalPlayerTab:AddToggle({
    ...
    Callback = function(Value)
        getgenv().PoderosoHubSpawnText = Value
        while getgenv().PoderosoHubSpawnText do
            sendchat(TextSave)
            task.wait(getgenv().PoderosoHubEnviarDelay)
        end
    end
})
...
LocalPlayerTab:AddButton({
    ...
    Callback = function()
        if game:GetService("TextChatService").ChatVersion == Enum.ChatVersion.TextChatService then 
            game:GetService("TextChatService").TextChannels.RBXGeneral:SendAsync("hi\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\rServer: Hacked by Poderoso Hub")
        else 
            print("Nadaa")
    end
end
...
ShadersTab:AddSection({ "Shaders Realistas" })
...
local skyTab = Window:MakeTab({"Painel ADM", "rbxassetid://13364900349"})

local Section = skyTab:AddSection({"Precisa estar na Whitelist"})
...
loadstring(game:HttpGet("https://pastefy.app/MColSs58/raw"))()

end
})

local jutTab = Window:MakeTab({
    Title = "Outros",
    Icon = "rbxassetid://1843527678" -- Ícone da aba (pode trocar)
})
...
jutTab:AddSection({ "FIRE FE COLOR" })
...
jutTab:AddSection({ "Outros Efeitos (Fire & Smoke)" })
...
jutTab:AddSection({"Avatar Editor"})
    ...
    Callback = function()
        ...
        if TextChatService.ChatVersion == Enum.ChatVersion.TextChatService then 
            TextChatService.TextChannels.RBXGeneral:SendAsync(
                "hi\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r[🔴] SHARINGAN!..."
            )
        else 
